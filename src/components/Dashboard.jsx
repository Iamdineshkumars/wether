    ...
    <div className='mt-16 lg:flex justify-center sm:flex sm:justify-center sm: mb-16 '>{/*This is main parent for Dashboard layout */}
      {
        data?.map((items)=>{ 
         ...
         <div className='border p-2 lg:w-[100%] col-span-2 rounded-2xl  max-sm: w-[120%] max-sm:h-96 shadow-xl shadow-neutral-600 opacity-80'>{/* child-1 , location */}
            <div className='p-4 lg:flex max-sm:flex-col '>
                <div className=''> {/* child-1 ,subchild-1 */}
                   <h1 className='text-2xl font-bold font-mono border-slate-600 border-b-2'>Country:  {items.location.country} </h1>
                   <h1 className='text-2xl font-bold font-mono mt-2 border-slate-600 border-b-2'>Region: {items.location.region}</h1>
                   <h1 className='text-2xl font-bold font-mono mt-2 border-slate-600 border-b-2'>TimeZone: {items.location.tz_id}</h1>
                    <h1 className='text-2xl font-mono font-bold mt-2'>Time: {items.location.localtime}</h1>
                </div>
         ...
         {/*---------------------------------------child-1-end------------------------------------------*/}
         <div className='border p-2  col-span-2 rounded-2xl lg:w-[100%]  max-sm:w-[120%] max-sm:h-[500px] shadow-xl shadow-neutral-600 opacity-80'>{/*child-2 ,current data*/}
            <div className='flex flex-row items-center gap-4 max-sm:flex-col lg:mt-4 max-sm:gap-8'>
            <div className='w-32 lg:mb-8'>{/* child-2 ,subchild-1 */}
             ...
             <div className='lg:w-48 max-sm:flex max-sm:gap-4 '>
              ...
              <div className='p-2  h-[80%] w-[50%] grid grid-cols-2 lg:gap-4 max-sm:border-none max-sm:flex max-sm:justify-end max-sm:ml-8 max-sm:w-[70%]' >
                ...
                <div  className='max-sm:mx-4'><img src={UVgif} className='h-8'/><h2 className='font-bold'>{items.current.uv}</h2><h3>UV</h3></div>
                 ...
                 {/*---------------------------------------child-2-end------------------------------------------*/} 
                 <div className=' border p-2 w-[140%] rounded-2xl lg:h-[130%] col-span-1  max-sm:w-[120%] max-sm:h-46 shadow-xl shadow-neutral-600 opacity-80'>{/* child3, theree days forecast */}
            ...
            {/*---------------------------------------child-3-end------------------------------------------*/}
         <div className='lg:ml-[90px] lg:h-[230%] border p-2 col-span-3 w-[90%] rounded-2xl  max-sm:w-[120%] max-sm:h-[100%] shadow-xl shadow-neutral-600 opacity-80 '>{/*child-4 , houly fourcast data */}
              ...
              <div className='p-4 flex flex-wrap gap-4 max-sm:flex-col '>
                {
                  nested_data.map((stage1)=>{
                    return <div key={stage1.id} className='lg:flex-col rounded-xl w-[100px] p-2 lg:shadow-2xl border border-slate-400 shadow-neutral-900 max-sm:border max-sm:border-slate-400 max-sm:shadow-xl max-sm:w-[100%] max-sm:flex  max-sm:items-center max-sm:p-4 shadow-gray-800'>
                      ...
                      <h1 className='font-bold pl-2 '>{stage1.wind_kph}kph</h1>
                      </div>
                  })
                }
